...
namespace Optimizer
{
    static class Program
    {
        ...
        private static bool ValidateLicense()
        {
            ...
            LicenseActivationForm licenseForm = new LicenseActivationForm();
            ...
            MessageBox.Show("Gamer Optimizer requires a valid license to run.\nPlease visit our website to purchase a license.", 
                            "License Required", 
